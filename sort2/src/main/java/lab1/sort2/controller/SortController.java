package lab1.sort2.controller;

import lab1.sort2.feign.FeignClientService;
import lab1.sort2.service.SortService;
...
public class SortController {
    ...
    public String service(@RequestParam("inputFile") String input) {
        ...
        return "sort1:" + sortService.sort(input) + "res1:" + res;
    }
}
