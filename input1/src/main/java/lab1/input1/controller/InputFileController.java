package lab1.input1.controller;

import lab1.input1.feign.FeignClientService;
import lab1.input1.service.InputService;
...
public class InputFileController {
    ...
    public String service(@RequestParam("inputFile") String input) {
        ...
        return "input1处理了这个请求, shuffle后的文件为:" + shuffleString;
    }
}
